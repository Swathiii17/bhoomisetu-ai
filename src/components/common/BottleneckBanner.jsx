  ...
  return (
    <div className="bg-gradient-to-r from-rose-950/90 via-slate-900 to-amber-950/80 border border-rose-700/60 rounded-2xl p-4 lg:p-5 shadow-2xl relative overflow-hidden my-4">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              {/* Bottleneck Detected */}
              <span className="bottleneck-white-label bg-rose-900/80 !text-white text-[10px] font-bold uppercase px-2 py-0.5 rounded border border-rose-700">
                BOTTLENECK DETECTED
              </span>
        ...
        <div className="bg-slate-950/80 border border-slate-700/70 p-3 rounded-xl min-w-[280px] text-xs">
          ...
          <p className="text-slate-200 mt-1 font-medium leading-tight">
            {project.aiRecommendations?.[0] ||
              'Escalate to District Collector for immediate Lok Adalat settlement.'}
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 pt-3 border-t border-rose-900/40 flex items-center space-x-4 text-xs overflow-x-auto text-slate-300">
        ...
        {/* Compensation */}
        <span className="bottleneck-white-label flex items-center space-x-1 !text-white font-bold bg-rose-950/80 px-2 py-0.5 rounded border border-rose-700">
          <AlertCircle size={14} />
          Compensation ⚠
        </span>
