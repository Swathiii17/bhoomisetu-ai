        ...
        <Link to="/" className="flex items-center space-x-3 group">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="brand-badge bg-indigo-900/60 text-indigo-300 border border-indigo-700/50 text-[10px] font-semibold px-2 py-0.5 rounded-full flex items-center space-x-1">
                <Sparkles className="w-2.5 h-2.5" />
                <span>SIH 2026</span>
              </span>
            </div>
            <p className="brand-subtitle text-[11px] text-slate-400 font-medium tracking-wide">
              {t('appSubtitle')}
            </p>
          </div>
        </Link>
      ...
      <div className="flex items-center space-x-3 lg:space-x-4">
        ...
        <div className="relative">
          <button
            ...
            className="role-switcher flex items-center space-x-2 bg-gradient-to-r from-slate-800 to-indigo-950/80 hover:from-slate-700 hover:to-indigo-900 text-indigo-200 border border-indigo-500/30 px-3 py-1.5 rounded-lg text-xs font-semibold shadow-sm transition-all"
          >
            <UserCheck className="w-3.5 h-3.5 text-emerald-400" />
            <span className="role-label hidden sm:inline">Role:</span>
            <span className="role-name text-emerald-300 font-bold">{roleLabels[currentUser?.role] || currentUser?.role}</span>
